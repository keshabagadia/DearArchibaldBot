/**
 * Prompt Schema:
 * - id (number): Unique identifier for the prompt. 1-20 are regular prompts, 101-120 are twist prompts.
 * - prompt (string): The text of the prompt, describing the situation or question.
 * - isTwist (boolean) (deprecated): Indicates this is a "twist prompt" (true) or a regular prompt (false).
...
module.exports = [
  ...
  createPrompt({
    id: 101,
    prompt: "This is a placeholder twist prompt for the 1.",
  }),
  createPrompt({
    id: 102,
    prompt: "This is a placeholder twist prompt for the 2.",
  }),
  createPrompt({
    id: 103,
    prompt: "This is a placeholder twist prompt for the 3.",
  }),
  createPrompt({
    id: 104,
    prompt: "This is a placeholder twist prompt for the 4.",
  }),
  createPrompt({
    id: 105,
    prompt: "This is a placeholder twist prompt for the 5.",
  }),
  createPrompt({
    id: 106,
    prompt: "This is a placeholder twist prompt for the 6.",
  }),
  createPrompt({
    id: 107,
    prompt: "This is a placeholder twist prompt for the 7.",
  }),
  createPrompt({
    id: 108,
    prompt: "This is a placeholder twist prompt for the 8.",
  }),
  createPrompt({
    id: 109,
    prompt: "This is a placeholder twist prompt for the 9.",
  }),
  createPrompt({
    id: 110,
    prompt: "This is a placeholder twist prompt for the 10.",
  }),
  createPrompt({
    id: 111,
    prompt: "This is a placeholder twist prompt for the 11.",
  }),
  createPrompt({
    id: 112,
    prompt: "This is a placeholder twist prompt for the 12.",
  }),
  createPrompt({
    id: 113,
    prompt: "This is a placeholder twist prompt for the 13.",
  }),
  createPrompt({
    id: 114,
    prompt: "This is a placeholder twist prompt for the 14.",
  }),
  createPrompt({
    id: 115,
    prompt: "This is a placeholder twist prompt for the 15.",
  }),
  createPrompt({
    id: 116,
    prompt: "This is a placeholder twist prompt for the 16.",
  }),
  createPrompt({
    id: 117,
    prompt: "This is a placeholder twist prompt for the 17.",
  }),
  createPrompt({
    id: 118,
    prompt: "This is a placeholder twist prompt for the 18.",
  }),
  createPrompt({
    id: 119,
    prompt: "This is a placeholder twist prompt for the 19.",
  }),
  createPrompt({
    id: 120,
    prompt: "This is a placeholder twist prompt for the 20.",
  }),
];
