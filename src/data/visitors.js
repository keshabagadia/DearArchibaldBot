module.exports = [
    {
      ...
      description: "Boris, a Badger, stumbles into your ${existingPlace.type}, visibly fatigued and carrying a heavy load.",
      level: 1,
      optionalScenarios: [
    ...
    },
    {
      ...
      description: "A field mouse comes in, his small child in tow. It is extremely clear that the kid is in serious need of some manners.",
      level: 1,
      optionalScenarios: [
        "The kid immediately breaks something in the ${existingPlace.type}. What is it?",
    ...
    },
    {
      ...
      level: 1,
      optionalScenarios: [
        "If this is a new visitor to your ${existingPlace.type}, one of you knows them already. Describe, in a flashback, about the awkward picnic you both ruined.",
    ...
    },
    {
      ...
      description: "A traveling bazaar rolls up to the ${existingPlace.type} and sets up for the day.",
      level: 1,
      optionalScenarios: [
    ...
    },
    {
      ...
      description: "Delilah, a Mole, walks into your ${existingPlace.type}.",
      level: 1,
      optionalScenarios: [
        ...
        "Delilah is looking for a temporary place to stay (unless she is already staying at the ${existingPlace.type}). But she is reluctant to stay here for fear of imposing. What happens next?"
      ]
    },
    {
    ...
    },
    {
      ...
      description: "Pip, a Chipmunk, arrives at your ${existingPlace.type}, grinning mischievously.",
      level: 2,
      optionalScenarios: [
    ...
    },
    {
      ...
      description: "Clay, a Raccoon, shuffles in. He is well-known for living on the fringes of polite animal society.",
      level: 2,
      optionalScenarios: [
