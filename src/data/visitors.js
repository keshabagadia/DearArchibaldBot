...
module.exports = [
  createVisitor({
    ...
    description: `Boris, a Badger, stumbles into your gathering place, visibly fatigued and carrying a heavy load.`,
    level: 1,
    optionalScenarios: [
  ...
  createVisitor({
    ...
    description: `A traveling bazaar rolls up to the gathering place and sets up for the day.`,
    level: 1,
    optionalScenarios: [
  ...
  createVisitor({
    ...
    description: `Pip, a Chipmunk, arrives at your gathering place, grinning mischievously.`,
    level: 2,
    optionalScenarios: [
  ...
  createVisitor({
    ...
    level: 2,
    memory: 1, // this one overrides the default
    optionalScenarios: [
